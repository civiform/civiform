...
- [ ] Tested both the Downs and the Ups manually by running the app on your branch (applies Ups), then running the branch on main (applies Downs) and testing that features that intersect with your Downs still work (eg. features that load a table you dropped a column in).
