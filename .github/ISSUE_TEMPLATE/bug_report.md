---
name: Bug report
about: Report unexpected or incorrect software behavior
title: ''
labels: bug
assignees: ''
---
...
Only list reproduction steps if you have personally reproduced the issue. If you haven't reproduced it please be clear about it but still provide some guidance.
...
Issues will be triaged weekly and addressed based on severity. An assignee will be added when the bug is being actively worked on. The issue may be assigned back to you if further information is needed. Reassign and add a comment to this ticket when that information is provided.
