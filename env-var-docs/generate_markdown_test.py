from generate_markdown import validate_env_variables, generate_markdown
import contextlib
import io
import os
import tempfile
    ...
    def test_doc_with_regex(self):
        input = """
        {
            "MY_VAR": {
                ...
                "regex": "^must_match$",
                "regex_tests": [
                    { "val": "must_match", "shouldMatch": true },
                    { "val": "can_match", "shouldMatch": false }
                ]
            }
        }
        """
