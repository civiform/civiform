...
test.describe('Applicant navigation flow', () => {
  test.describe('navigation with five blocks', () => {
    ...
    //   test('answering questions out of order', async ({page, applicantQuestions}) => {
    //     await applicantQuestions.clickApplyProgramButton(programName)
    ...
    //   test('clicking previous on later blocks goes to previous blocks', async ({applicantQuestions}) => {
    //     await applicantQuestions.applyProgram(programName)
    ...
    //   test('clicking previous with correct form shows previous page and saves answers', async ({applicantQuestions}) => {
    //     await applicantQuestions.applyProgram(programName)
    //     await applicantQuestions.answerDateQuestion('2021-11-01')
    //     await applicantQuestions.answerEmailQuestion('test1@gmail.com')
    ...
    //   test('clicking previous with some missing answers shows error modal', async ({page, applicantQuestions}) => {
    //     await applicantQuestions.applyProgram(programName)
    //     await applicantQuestions.answerDateQuestion('')
    //     await applicantQuestions.answerEmailQuestion('test1@gmail.com')
    ...
    //   test('clicking previous with no answers does not show error modal', async ({applicantQuestions}) => {
    //     await applicantQuestions.applyProgram(programName)
    ...
    //   test('error on previous modal > click stay and fix > shows block', async ({applicantQuestions}) => {
    //     await applicantQuestions.applyProgram(programName)
    //     await applicantQuestions.answerDateQuestion('')
    //     await applicantQuestions.answerEmailQuestion('test1@gmail.com')
    ...
    //   test('error on previous modal > click previous without saving > answers not saved', async ({applicantQuestions}) => {
    //     await applicantQuestions.applyProgram(programName)
    //     await applicantQuestions.answerDateQuestion('2021-11-01')
    //     await applicantQuestions.answerEmailQuestion('')
    ...
    //   test('error on previous modal > click previous without saving > shows previous block', async ({applicantQuestions}) => {
    //     await applicantQuestions.applyProgram(programName)
    //     await applicantQuestions.answerDateQuestion('2021-11-01')
    //     await applicantQuestions.answerEmailQuestion('test1@gmail.com')
    //     await applicantQuestions.clickNext()
    ...
    //   test('clicking previous after deleting answers to required questions shows error modal', async ({applicantQuestions}) => {
    ...
    //   test('previous saves blank optional answers', async ({applicantQuestions}) => {
    ...
    //   test('clicking review with correct form shows review page with saved answers', async ({applicantQuestions}) => {
    //     await applicantQuestions.applyProgram(programName)
    //     await applicantQuestions.answerDateQuestion('2021-11-01')
    //     await applicantQuestions.answerEmailQuestion('test1@gmail.com')
    ...
    //   test('clicking review with some missing answers shows modal', async ({page, applicantQuestions}) => {
    //     await applicantQuestions.applyProgram(programName)
    //     await applicantQuestions.answerDateQuestion('')
    //     await applicantQuestions.answerEmailQuestion('test1@gmail.com')
    ...
    //   test('clicking review with no answers does not show error modal', async ({applicantQuestions}) => {
    //     await applicantQuestions.applyProgram(programName)
    ...
    //   test('error on review modal > click stay and fix > shows block', async ({applicantQuestions}) => {
    //     await applicantQuestions.applyProgram(programName)
    //     await applicantQuestions.answerDateQuestion('')
    //     await applicantQuestions.answerEmailQuestion('test1@gmail.com')
    ...
    //   test('error on review modal > click review without saving > shows review page without saved answers', async ({applicantQuestions}) => {
    //     await applicantQuestions.applyProgram(programName)
    //     await applicantQuestions.answerDateQuestion('2021-11-01')
    //     await applicantQuestions.answerEmailQuestion('')
    ...
    //   test('clicking review after deleting answers to required questions shows error modal', async ({applicantQuestions}) => {
    //     await test.step('answer questions on first block', async () => {
    //       await applicantQuestions.applyProgram(programName)
    //       await applicantQuestions.answerDateQuestion('2021-11-01')
    //       await applicantQuestions.answerEmailQuestion('test1@gmail.com')
    ...
    //   test('review saves blank optional answers', async ({applicantQuestions}) => {
    //     await test.step('answer blocks with all required questions', async () => {
    //       await applicantQuestions.applyProgram(programName)
    //       await applicantQuestions.answerDateQuestion('2021-11-01')
    //       await applicantQuestions.answerEmailQuestion('test1@gmail.com')
    ...
    test('verify program submission page for guest', async ({page, applicantQuestions, adminPrograms}) => {
    await applicantQuestions.applyProgram(programName)
