...
test.describe('Program admin review of submitted applications', {tag: ['@northstar']} , () => {
  ...
  test('all major steps with multiple file upload flag', async ({
    ...
    await test.step('Fill out first application block', async () => {
      ...
      await applicantQuestions.answerMemorableDateQuestion('2021', '05 - May', '10')
      ...
      await expect(page.getByText('Error: Please enter valid street name and number.')).toBeVisible()

      // await expect(page.locator('.cf-address-city-error:visible')).toHaveText(
      //   'Error: Please enter city.',
      // )
      await expect(page.getByText('Error: Please enter city.')).toBeVisible()
      ...
      // )
      await expect(page.getByText('Error: Please enter state.')).toBeVisible()


      // await expect(page.locator('.cf-address-zip-error:visible')).toHaveText(
      //   'Error: Please enter valid 5-digit ZIP code.',
      // )
      await expect(page.getByText('Error: Please enter valid 5-digit ZIP code.')).toBeVisible()


      // await expect(page.locator('.cf-name-first-error:visible')).toHaveText(
      //   'Error: Please enter your first name.',
      // )
      await expect(page.getByText('Error: Please enter your first name.')).toBeVisible()


      // await expect(page.locator('.cf-name-last-error:visible')).toHaveText(
      //   'Error: Please enter your last name.',
      // )
      await expect(page.getByText('Error: Please enter your last name.')).toBeVisible()
    ...
    await test.step('Fill out second application block', async () => { // TODO ssandbekkhaug
