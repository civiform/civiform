...
test.describe('address applicant flow', () => {
  ...
  test.describe('multiple address questions', () => {
    ...
    test.beforeEach(async ({page, adminPrograms, adminQuestions, seeding}) => {
      ...
      // The seed contains a single address question, so the second one is
  ...
  test.describe('optional address question', () => {
    ...
    test.beforeEach(async ({page, adminPrograms, adminQuestions, seeding}) => {
      ...
      // The seed contains a single address question (used as the optional
      // question here), so the required one is still created via the UI.
      await adminQuestions.addAddressQuestion({
