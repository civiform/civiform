...
describe('Applicant navigation flow', () => {
  ...
  describe('navigation with five blocks', () => {
    ...
    it('verify program list page', async () => {
      ...
      expect(cardHtml).toContain(
        '<a href="https://www.example.com" class="text-sm text-blue-900 font-bold opacity-75 underline hover:opacity-100" target="_blank" rel="nofollow noopener noreferrer">website<svg',
      )
