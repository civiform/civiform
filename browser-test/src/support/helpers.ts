...
export class Helpers {
  ...
  async loginAsAdmin() {
    await this.page.goto(
      '/callback?client_name=FakeAdminClient&adminType=GLOBAL',
    )
  ...
  async loginAsProgramAdmin() {
    await this.page.goto(
      '/callback?client_name=FakeAdminClient&adminType=PROGRAM',
    )
    // await this.page.click('#debug-content-modal-button')
  ...
  async loginAsTestUserAwsStaging(loginButton: string, isTi: boolean) {
    await Promise.all([
  ...
  async loginAsTestUserFakeOidc(loginButton: string, isTi: boolean) {
    await Promise.all([
