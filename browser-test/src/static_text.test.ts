...
describe('Static text question for applicant flow', () => {
  ...
  it('parses markdown', async () => {
    ...
    expect(await page.innerHTML('.cf-applicant-question-text')).toContain(
      '<a href="https://www.example.com" class="text-blue-600 hover:text-blue-500 underline" target="_blank" rel="nofollow noopener noreferrer">This is a link<svg',
    )
    expect(await page.innerHTML('.cf-applicant-question-text')).toContain(
    ...
    expect(await page.innerHTML('.cf-applicant-question-text')).toContain(
      '<p>This link should be autodetected: <a href="https://www.example.com" class="text-blue-600 hover:text-blue-500 underline" target="_blank" rel="nofollow noopener noreferrer">https://www.example.com<svg',
    )
    expect(await page.innerHTML('.cf-applicant-question-text')).toContain(
