...
lazy val root = (project in file("."))
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      // Amazon AWS SDK
      "software.amazon.awssdk" % "s3" % "2.42.2",
      "software.amazon.awssdk" % "ses" % "2.42.2",
      ...
      "org.pac4j" % "pac4j-core" % "6.3.2",
      // basic http authentication (for the anonymous client)
      "org.pac4j" % "pac4j-http" % "6.3.2",
      // OIDC authentication
      "org.pac4j" % "pac4j-oidc" % "6.3.2",
      // SAML authentication
      "org.pac4j" % "pac4j-saml" % "6.3.2",
      ...
      // Errorprone
      "com.google.errorprone" % "error_prone_core" % "2.47.0",
