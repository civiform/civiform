...
public final class TransactionManager {
   ...
   * </ul>
   *
   * @param work the {@link Supplier} to run inside a transaction
   ...
   */
  public <T> T executeInTransaction(Supplier<T> work, Supplier<T> onSerializationFailure) {
    checkNotNull(work);
    ...
    // todo confirm that the transaction is ended and rolled back
  }
}
