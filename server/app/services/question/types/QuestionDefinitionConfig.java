...
public abstract class QuestionDefinitionConfig {
  ...
  abstract ImmutableList<PrimaryApplicantInfoTag> primaryApplicantInfoTags();
  ...
  public static RequiredName builder() {
    return new AutoValue_QuestionDefinitionConfig.Builder()
        .setUniversal(false)
        .setPrimaryApplicantInfoTags(ImmutableList.of());
  }
  ...
  public abstract static class Builder
    ...
    public abstract Builder setPrimaryApplicantInfoTags(ImmutableList<PrimaryApplicantInfoTag> primaryApplicantInfoTags);
