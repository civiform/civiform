...
public abstract class QuestionDefinition {
   ...
   */
  @JsonIgnore
  public Optional<ImmutableSet<LocalizedQuestionSetting>> getSettingsForLocaleOrDefault(Locale locale) {
    if (config.questionSettings().isEmpty()) {
      return Optional.empty();
    }

    return Optional.of(config.questionSettings().get().stream()
