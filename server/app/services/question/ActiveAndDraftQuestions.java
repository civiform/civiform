...
public final class ActiveAndDraftQuestions {
  ...
  public ImmutableList<QuestionDefinition> getActiveAndDraftQuestions() {
    ...
    ImmutableList<String> draftQuestionNames =
        draftQuestions.stream()
            .map(question -> question.getName())
            .collect(ImmutableList.toImmutableList());
    ImmutableList<QuestionDefinition> activeQuestionsWithoutDrafts =
        getActiveQuestions().stream()
            .filter(
                question -> {
    ...
    return ImmutableList.<QuestionDefinition>builder()
        .addAll(activeQuestionsWithoutDrafts)
        .addAll(draftQuestions)
        .build();
  }
