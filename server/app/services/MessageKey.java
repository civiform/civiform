...
public enum MessageKey {
  ...
  BUTTON_ADD_NESTED_REPEATED_SET("button.addNestedRepeatedSet"),
  ...
  CURRENCY_VALIDATION_MISFORMATTED_V2("validation.currencyMisformatted.v2"),
  ...
  DATE_VALIDATION_DAY_INVALID("validation.dayInvalid"),
  DATE_VALIDATION_YEAR_INVALID("validation.yearInvalid"),
  DAY_LABEL("label.day"),
  ...
  FILEUPLOAD_INPUT_ARIA_LABEL("input.filesAlreadyUploadedAriaLabel"),
  ...
  NUMBER_VALIDATION_NON_INTEGER_v2("validation.numberNonInteger.v2"),
