...
public enum MessageKey {
  ...
  FILEUPLOAD_INPUT_ARIA_LABEL_SINGULAR("input.filesAlreadyUploadedAriaLabel.singular"),
  FILEUPLOAD_INPUT_ARIA_LABEL_PLURAL("input.filesAlreadyUploadedAriaLabel.plural"),
