...
public enum MessageKey {
  ...
  MODAL_ERROR_SAVING_CONTENT_PREVIEW("modal.errorSaving.content.preview"), // North Star only
  MODAL_ERROR_SAVING_NO_SAVE_BUTTON("modal.errorSaving.noSaveButton"), // North Star only
