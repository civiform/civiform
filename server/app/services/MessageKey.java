...
public enum MessageKey {
  ...
  ERROR_NOT_FOUND_DESCRIPTION_A_END("error.not_found_description_a_end"),
  ERROR_NOT_FOUND_DESCRIPTION_B("error.not_found_description_b"),
  ERROR_NOT_FOUND_DESCRIPTION_B_END("error.not_found_description_b_end"),
  ERROR_NOT_FOUND_DESCRIPTION_LINK("error.not_found_description_link"),
  ERROR_NOT_FOUND_IMG_CAPTION_A("error.img_caption_a"),
  ERROR_NOT_FOUND_IMG_CAPTION_B("error.img_caption_b"),
  ERROR_NOT_FOUND_IMG_CAPTION_C("error.img_caption_c"),
  ERROR_NOT_FOUND_IMG_CAPTION_D("error.img_caption_d"),
