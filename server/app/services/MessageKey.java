...
public enum MessageKey {
  ...
  REQUIRED_FIELDS_ANNOTATION_FIRST_HALF("content.requiredFieldsAnnotationFirstHalf"),
  REQUIRED_FIELDS_ANNOTATION_SECOND_HALF("content.requiredFieldsAnnotationSecondHalf"),
