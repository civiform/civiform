...
public enum MessageKey {
  ...
  DATE_VALIDATION_INVALID_DATE("validation.invalidDate"),
  DATE_VALIDATION_IMPOSSIBLE_DATE("validation.impossibleDate"),
  DATE_VALIDATION_UNREASONAL_FUTURE_DATE("validation.unreasonableFutureDate"),
