...
public enum MessageKey {
  ...
  NAME_OR_EMAIL_LABEL("label.searchByName"),
  ...
  PHONE_NUMBER_LABEL("label.phoneNumber"),
  ...
  TITLE_ACCT_SETTING("title.acctSettings"),
  ...
  TITLE_CLIENT_LIST("title.clientList"),
  ...
  TITLE_DISPALY_ONE_CLIENT("title.displayingOneClient"),
