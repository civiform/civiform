...
public class PdfExporter {
   ...
   * function creates the output document in memory due as byte[] and written to output document
   * using ContentType as "application/pdf"
   */
   private byte[] buildPDF(
     ...
     Paragraph applicant = new Paragraph(
     ...
     for (AnswerData answerData : answers) {
       ...
       Paragraph time =
           new Paragraph(
              "Answered on : " + date, FontFactory.getFont(FontFactory.HELVETICA, 10));
