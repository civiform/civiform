...
public class CfJsonDocumentContext {
   ...
   * java.util.ArrayList} (Guava's immutable collections reject nulls) and read the values back with
   * {@link #readNullableDoubleList}.
   *
   ...
   * Optional#empty} and silently vanish. Write such arrays with {@link #putArray(Path, List)} using
   * a plain {@link ArrayList}.
   *
   * @param path the {@link Path} to the list
