 ...
 *
 * <p>If the filtering attempt was not successful, contains all the accounts of the TIGroup
 * along with the error message of why the filtering failed.
 *
 */
public final class TrustedIntermediarySearchResult {
  ...
  private TrustedIntermediarySearchResult(Optional<ImmutableList<Account>> accounts,Optional<String> errorMessage) {
  ...
  public static TrustedIntermediarySearchResult success(ImmutableList<Account> searchResult) {
    return new TrustedIntermediarySearchResult(Optional.of(searchResult), /* errorMessage= */ Optional.empty());
  }
  public static TrustedIntermediarySearchResult fail(ImmutableList<Account> allAccount, String errorMessage) {
