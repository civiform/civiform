...
public final class SettingsManifest extends AbstractSettingsManifest {
   ...
   */
  public Optional<String> getPreScreenerMoreResourcesLinkText(RequestHeader request) {
   ...
   * when the applicant is not eligible for any programs in CiviForm.
   */
  public Optional<String> getPreScreenerMoreResourcesLinkHref(RequestHeader request) {
