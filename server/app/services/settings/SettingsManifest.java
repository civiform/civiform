...
public final class SettingsManifest extends AbstractSettingsManifest {
  ...
  public Optional<String> getNorthStarUiPrimaryColor(RequestHeader request) {
    return getString("NORTH_STAR_UI_PRIMARY_COLOR", request);
  }
