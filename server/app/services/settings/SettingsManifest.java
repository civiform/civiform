...
public final class SettingsManifest extends AbstractSettingsManifest {
  ...
  public Optional<String> getImmigrationStatusInfoBannerLearnMoreUrl() {
    return getString("IMMIGRATION_STATUS_INFO_BANNER_LEARN_MORE_URL");
  }
  ...
  public boolean getImmigrationStatusInfoBannerEnabled() {
    return getBool("IMMIGRATION_STATUS_INFO_BANNER_ENABLED");
  }
  ...
  public boolean getAdminUiMigrationScEnabled() {
    return getBool("ADMIN_UI_MIGRATION_SC_ENABLED");
  }

  /** (NOT FOR PRODUCTION USE) Enable extended options in the admin UI migration in Thymeleaf. */
  public boolean getAdminUiMigrationScExtendedEnabled() {
    return getBool("ADMIN_UI_MIGRATION_SC_EXTENDED_ENABLED");
  }
