...
public final class ApplicationScoreCalculator {
   ...
   * @param snapshot the application's private {@link ApplicantData} copy; never the applicant's own
   *     shared instance
  ...
  private static BigDecimal enrichSingleSelectQuestion(
    ...
    Optional<Long> selectedOptionId = snapshot.readLong(contextualizedPath.join(Scalar.SELECTION));
