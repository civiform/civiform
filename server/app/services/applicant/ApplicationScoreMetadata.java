...
/**
 * Owns the JSON keys and paths of the answer-option score data written to a submitted application's
 * private snapshot.
 *
 ...
 * {@code applicant} tree entirely. Applicant update endpoints reject the three key names in scalar
 * position as reserved (see {@link #isReservedScoreKey}).
 */
