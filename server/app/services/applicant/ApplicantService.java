...
public final class ApplicantService {
   ...
   *     resolved at the controller boundary. When true and the submitted program version has {@code
   *     usesScoring}, score metadata is written to the application's private snapshot.
   */
  public CompletionStage<ApplicationModel> submitApplication(
      long applicantId,
      long programId,
