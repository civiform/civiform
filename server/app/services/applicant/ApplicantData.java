...
public class ApplicantData extends CfJsonDocumentContext {
  ...
  // TODO (#5503): Remove these WellKnownPath functions once we remove
  // the feature flag.
  ...
  public Optional<String> getApplicantMiddleNameAtWellKnownPath() {
    return readString(WellKnownPaths.APPLICANT_MIDDLE_NAME);
  }

  public Optional<String> getApplicantLastNameAtWellKnownPath() {
    return readString(WellKnownPaths.APPLICANT_LAST_NAME);
  }

  /** Updates the TI client name in the Applicant table */
  public void updateUserNameAtWellKnownPath(
  ...
  public void setUserNameAtWellKnownPath(String displayName) {
    String firstName;
    ...
    setUserNameAtWellKnownPath(firstName, middleName, lastName);
  }

  public void setUserNameAtWellKnownPath(
      String firstName, @Nullable String middleName, @Nullable String lastName) {
    if (!hasPath(WellKnownPaths.APPLICANT_FIRST_NAME)) {
      putString(WellKnownPaths.APPLICANT_FIRST_NAME, firstName);
    }
  ...
  public Optional<String> getPhoneNumberAtWellKnownPath() {
    return readString(WellKnownPaths.APPLICANT_PHONE_NUMBER);
  }

  public void setPhoneNumberAtWellKnownPath(String phoneNumber) {
    putPhoneNumber(WellKnownPaths.APPLICANT_PHONE_NUMBER, phoneNumber);
  }

  public Optional<LocalDate> getDateOfBirthAtWellKnownPath() {
  ...
  public void setDateOfBirthAtWellKnownPath(String dateOfBirth) {
