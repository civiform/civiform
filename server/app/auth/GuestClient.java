...
public class GuestClient extends IndirectClient {
  ...
  // value is being handled by the parent class.
  @Override
  protected void internalInit(final boolean forceReinit) {

    /*
     * This is the root of the non-logged-in auth story. This class is invoked to provide a profile
     * for a user who hits /callback?client_name=GuestClient. It extracts "credentials" from the
     * request (the creds are empty since the user is not logged in) and "authenticates" them,
     * loading a profile which is generated by the ProfileFactory. Then it redirects the user to the
     * home page.
     */
