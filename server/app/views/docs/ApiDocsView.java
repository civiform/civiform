...
public class ApiDocsView extends BaseHtmlView {
  ...
  private DivTag apiResponseSampleDiv(ProgramDefinition programDefinition, boolean scoringEnabled) {
    DivTag apiResponseSampleDiv = div();
    String fullJsonResponsePreview =
        programJsonSampler.getSampleJson(programDefinition, scoringEnabled);
