...
public final class CheckboxElementTagModelProcessor extends AbstractElementModelProcessor {
  ...
  protected void doProcess(
    ...
    var itemValidationResults = itemSettingsList.stream()
    ...
    for (var itemSettings : itemSettingsList) {
      ...
      checkboxDivAttrs.putIf(isNotBlank(itemSettings.thEach().value()), "th:each", itemSettings.thEach().value());
  ...
  private static void addCheckboxInputElement(
    ...
    inputAttrs.putIf(
      ...
      // itemSettings.id().isThymeleafAttribute() ? "th:id" : "id",
