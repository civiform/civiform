...
public class ButtonFormSettings {
  ...
  public String getVariantCssClass() {
    return switch (variant().value()) {
      case "secondary", "outline", "accent-cool", "accent-warm", "base", "unstyled" ->
          "usa-button--%s".formatted(variant().value());
      default -> "";
    };
  }
