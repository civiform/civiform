...
public class NorthStarApplicantNotEligibleView extends NorthStarApplicantBaseView {

  @Inject
  NorthStarApplicantNotEligibleView(
  ...
  public String render(Params params) {
    ...
    return templateEngine.process("applicant/ApplicantNotEligibleTemplate", context);
  }
  ...
  public abstract static class Params {
    ...
    public static Builder builder() {
      return new AutoValue_NorthStarApplicantNotEligibleView_Params.Builder();
    }
