...
public class ProgramFormBuilder extends BaseHtmlView {
    ...
    formTag
        .with(
            ...
            FieldWithLabel.input()
                ...
                .withClass(SPACE_BETWEEN_FORM_ELEMENTS),
            // Program slug
            buildProgramSlugField(adminName, programEditStatus, programType),
            // Admin description
            ...
            iff(
                ...
                fieldset(
                        legend(
                                "Application scoring - apply answer option scores to submitted"
                                    + " applications")
                            .withClass("text-gray-600"),
                        buildUSWDSCheckboxOption(
                            "program-uses-scoring",
                            SCORING_FIELD_NAME,
                            usesScoring,
                            isExternalProgram,
                            "Enable application scoring"))
            ...
            FieldWithLabel.textArea()
                ...
                .setDisabled(isExternalProgram)
                .setReadOnly(isExternalProgram)
  ...
  protected DomContent buildProgramSlugField(
