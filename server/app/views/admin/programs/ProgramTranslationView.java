...
public class ProgramTranslationView extends TranslationFormView {
  ...
  @Inject
  public ProgramTranslationView(AdminLayoutFactory layoutFactory, Langs langs, @ApplicationStatusTrackingEnabled boolean statusTrackingEnabled) {
    super(langs);
  ...
  private ImmutableList<Tag> formFields(
    ...
    ImmutableList.Builder<Tag> result = ImmutableList.<Tag>builder()
        .add(fieldset()
  ...
  abstract static class ApplicationStatus {
    ...
    static ApplicationStatus create(String statusName, String emailContent) {
      return new AutoValue_ProgramTranslationView_ApplicationStatus(
          statusName, emailContent);
    }
