...
public enum Icons {
  ...
  // Settings/preferences edit symbol
  COG(
      "0 -960 960 960",
      "m388-80-20-126q-19-7-40-19t-37-25l-118 54-93-164 108-79q-2-9-2.5-20.5T185-480q0-9"
          + " .5-20.5T188-521L80-600l93-164 118 54q16-13 37-25t40-18l20-127h184l20 126q19 7 40.5"
          + " 18.5T669-710l118-54 93 164-108 77q2 10 2.5 21.5t.5 21.5q0 10-.5 21t-2.5 21l108 78-93"
          + " 164-118-54q-16 13-36.5 25.5T592-206L572-80H388Zm92-270q54 0"
          ...
          + " 6.5-33.5T715-480q0-17-2-33.5t-7-33.5l94-69-40-72-106"
          + " 46q-23-26-52-43.5T538-708l-14-112h-88l-14 112q-34 7-63.5 24T306-642l-106-46-40 72 94"
          + " 69q-4 17-6.5 33.5T245-480q0 17 2.5 33.5T254-413l-94 69 40 72 106-46q24 24 53.5"
          + " 41t62.5 25l14 112Z"),
  // Place
  ADDRESS(
      24,
  ...
  CAKE(
      24,
      "M12 7C13.11 7 14 6.1 14 5C14 4.62 13.9 4.27 13.71 3.97L12"
          + " 1L10.29 3.97C10.1 4.27 10 4.62 10 5C10 6.1 10.9 7 12 7ZM18 10H13V8H11V10H6C4.34"
          + " 10 3 11.34 3 13V22C3 22.55 3.45 23 4 23H20C20.55 23 21 22.55 21 22V13C21 11.34"
          + " 19.66 10 18 10ZM19 21H5V18C5.9 17.99 6.76 17.63 7.4 16.99L8.49 15.92L9.56"
          + " 16.99C10.87 18.3 13.15 18.29 14.45 16.99L15.53 15.92L16.6 16.99C17.24 17.63"
          + " 18.1 17.99 19 18V21ZM19 16.5C18.49 16.49 18.01 16.3 17.65 15.93L15.52 13.8L13.38"
  ...
  // Icon representing a generic / placeholder image
  IMAGE(
      "0 -960 960 960",
  ...
  NAVIGATE_BEFORE(24, "M15.41 7.41 14 6l-6 6 6 6 1.41-1.41L10.83 12z"),
  NAVIGATE_NEXT(24, "M10 6 8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"),
  NOISE_CONTROL_OFF(
      20,
  ...
  PHONE(
      24,
      "M6.54 5c.06.89.21 1.76.45 2.59l-1.2 1.2c-.41-1.2-.67-2.47-.76-3.79h1.51m9.86 12.02c.85.24"
          + " 1.72.39 2.6.45v1.49c-1.32-.09-2.59-.35-3.8-.75l1.2-1.19M7.5 3H4c-.55 0-1 .45-1 1 0"
          + " 9.39 7.61 17 17 17 .55 0 1-.45 1-1v-3.49c0-.55-.45-1-1-1-1.24"
          + " 0-2.45-.2-3.57-.57-.1-.04-.21-.05-.31-.05-.26 0-.51.1-.71.29l-2.2"
          + " 2.2c-2.83-1.45-5.15-3.76-6.59-6.59l2.2-2.2c.28-.28.36-.67.25-1.02C8.7 6.45 8.5 5.25"
          + " 8.5 4c0-.55-.45-1-1-1z"),
  // Numbers
  NUMBER(
      24,
  ...
  KEYBOARD_ARROW_DOWN("0 -960 960 960", "M480-344 240-584l56-56 184 184 184-184 56 56-240 240Z"),
  TRANSLATE(
      48,
  ...
  private final Optional<String> viewBox;

  Icons(int size, String path) {
    this.size = size;
    this.path = path;
    this.viewBox = Optional.empty();
  }

  Icons(String viewBox, String path) {
    this.viewBox = Optional.of(viewBox);
    this.path = path;
    this.size = 0;
  }
  ...
  public static SvgTag questionTypeSvgLink(QuestionType type) {
    ...
    return new SvgTag()
      .with(new UseTag().attr("href", "#" + makeSvgLinkId(icon)));
  }
