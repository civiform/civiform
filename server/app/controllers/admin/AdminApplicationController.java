...
public final class AdminApplicationController extends CiviFormController {
  ...
  public Result downloadAllJson(
    ...
    SubmittedApplicationFilter filter = SubmittedApplicationFilter.EMPTY;
    ...
    String json =
        jsonExporter
            .export(program, IdentifierBasedPaginationSpec.MAX_PAGE_SIZE_SPEC_LONG, filter)
            .getLeft();
  ...
  public Result downloadAll(
    ...
    try {
      ...
      String csv = exporterService.getProgramAllVersionsCsv(programId, filter);
      return ok(csv)
  ...
  public Result index(
    ...
    PaginationResult<Application> applications =
        programService.getSubmittedProgramApplicationsAllVersions(
            programId, F.Either.Right(paginationSpec), filter);
