...
public final class AddressCheckerController extends Controller {
  ...
  public Result index(Http.Request request) {
    if (settingsManifest.getAdminUiMigrationScEnabled(request)) {
      AddressCheckerPageViewModel model = AddressCheckerPageViewModel.builder()
          ...
          .addressValidationEnabled(settingsManifest.getEsriAddressServiceAreaValidationEnabled(request))
          .findAddressCandidatesUrls(settingsManifest.getEsriFindAddressCandidatesUrls())
          .addressServiceAreaValidationUrls(settingsManifest.getEsriAddressServiceAreaValidationUrls())
          .build();
