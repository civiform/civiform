...
import views.applicant.index.FilteredProgramsPartial;
import views.applicant.index.ProgramIndexView;
import views.applicant.overview.ApplicantDisabledProgramView;
...
public final class ApplicantProgramsController extends CiviFormController {
  ...
  private final FilteredProgramsPartial filteredProgramsPartial;
  ...
  public ApplicantProgramsController(
      ...
      FilteredProgramsPartial filteredProgramsPartial,
    ...
    this.filteredProgramsPartial = checkNotNull(filteredProgramsPartial);
  ...
  public CompletionStage<Result> hxFilter(
    ...
    return CompletableFuture.supplyAsync(
            () ->
                Results.ok(
                        filteredProgramsPartial.render(
                            messagesApi.preferred(request),
                            request,
                            maybeApplicantId,
                            ApplicantPersonalInfo.ofGuestUser(),
