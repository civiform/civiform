...
public final class BindingAnnotations {
  ...
  /**
   * Holds the {@link DurableJobRegistry} that contains recurring job types to be run by the
   * ActorSystem.
   */
  @Qualifier
  @Target({FIELD, PARAMETER, METHOD})
  ...
  /**
   * Holds the {@link DurableJobRegistry} that contains startup job types to be run during
   * application startup.
   */
  @Qualifier
  @Target({FIELD, PARAMETER, METHOD})
