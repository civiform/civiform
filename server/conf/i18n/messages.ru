...
text.repeatedSet.addQuestionDescription=Add a repeated set that will ask residents to add objects or individuals to a list. If a repeated set has already been added and you would like to select a different one, delete the question below.
...
description.repeatedSet.createNewQuestion=Create a new repeated set question from this screen. We''ll save it for you in the question bank for future use.
#An informative description below the option to choose an existing question
description.repeatedSet.chooseExistingQuestion=Add an existing repeated set from the question bank.
