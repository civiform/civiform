...
input.repeatedSet.hintText=Hint text
# A form field where admins set the minimum number of entities that applicants must list
input.repeatedSet.minEntities=Minimum entity count
