...
public class GcpMultipartUploadSinkProviderTest extends ResetPostgres {
  ...
  public void setUp() {
    ...
    uploadSinkProvider = spy(new GcpMultipartUploadSinkProvider(instanceOf(Config.class)));
