  ...
  public void basic_checkbox() {
    assertHtml(
        ...
        <cf:checkbox
          ...
          <item id="email" value="email" text="Email notifications"/>
          <item id="sms" value="sms" text="SMS notifications"/>
        </cf:checkbox>
        """,
        // expected
        """
  ...
  public void checkbox_with_help_text() {
    assertHtml(
        ...
        <cf:checkbox
          ...
          <item id="push" value="push" text="Push"/>
        </cf:checkbox>
        """,
        // expected
        """
  ...
  public void checkbox_with_validation_error() {
    assertHtml(
        ...
        <cf:checkbox
          ...
          <item id="accept" value="accept" text="I accept the terms and conditions"/>
        </cf:checkbox>
        """,
        // expected
        """
  ...
  public void checkbox_with_error_and_help_text() {
    assertHtml(
        ...
        <cf:checkbox
            ...
            th:is-valid="${model.isValid()}"
            th:validation-message="${model.validationMessage()}">
          <item id="java" value="java" text="Java"/>
          <item id="python" value="python" text="Python"/>
        </cf:checkbox>
        """,
        // expected
        """
  ...
  public void required_checkbox() {
    assertHtml(
        ...
        <cf:checkbox
          ...
          <item id="agree" value="agree" text="I agree"/>
        </cf:checkbox>
        """,
        // expected
        """
  ...
  public void checkbox_with_selected_item() {
    assertHtml(
        ...
        <cf:checkbox
            ...
            th:name="${model.name()}"
            th:label="${model.label()}">
          <item id="red" value="red" text="Red" selected="true"/>
          <item id="blue" value="blue" text="Blue"/>
          <item id="green" value="green" text="Green" selected="true"/>
        </cf:checkbox>
        """,
        // expected
        """
  ...
  public void checkbox_with_disabled_item() {
    assertHtml(
        ...
        <cf:checkbox
            ...
            th:name="${model.name()}"
            th:label="${model.label()}">
          <item id="feature1" value="feature1" text="Feature 1"/>
          <item id="feature2" value="feature2" text="Feature 2" disabled="true"/>
          <item id="feature3" value="feature3" text="Feature 3"/>
        </cf:checkbox>
        """,
        // expected
        """
...
<cf:checkbox
    ...
    th:name="${model.name()}"
    th:label="${model.label()}">
  <item id="basic" value="basic" text="Basic Plan" description="$10/month - Essential features"/>
  <item id="pro" value="pro" text="Pro Plan" description="$20/month - All features included"/>
</cf:checkbox>
""",
        // expected
        """
  ...
  public void checkbox_with_columns() {
    assertHtml(
        ...
        <cf:checkbox
          ...
          <item id="sports" value="sports" text="Sports"/>
          <item id="music" value="music" text="Music"/>
          <item id="art" value="art" text="Art"/>
          <item id="tech" value="tech" text="Technology"/>
        </cf:checkbox>
        """,
        // expected
        """
...
<cf:checkbox
    ...
    th:name="${model.name()}"
    th:label="${model.label()}">
  <item id="track1" value="track1" text="Option 1" data-testid="tracking-checkbox" data-analytics="track-me"/>
</cf:checkbox>
""",
        // expected
        """
...
""");
  ...
  @Test
  public void checkbox_item_without_text_throws() {
    assertException(
        // template
        """
        <cf:checkbox
