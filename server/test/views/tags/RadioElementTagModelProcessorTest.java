  ...
  public void basic_radio() {
    assertHtml(
        ...
        <cf:radio
          ...
          <item id="email" value="email" text="Email"/>
          <item id="phone" value="phone" text="Phone"/>
        </cf:radio>
        """,
        // expected
        """
  ...
  public void radio_with_help_text() {
    assertHtml(
        ...
        <cf:radio
          ...
          <item id="standard" value="standard" text="Standard"/>
          <item id="express" value="express" text="Express"/>
        </cf:radio>
        """,
        // expected
        """
  ...
  public void radio_with_validation_error() {
    assertHtml(
        ...
        <cf:radio
          ...
          <item id="male" value="male" text="Male"/>
          <item id="female" value="female" text="Female"/>
        </cf:radio>
        """,
        // expected
        """
...
<fieldset class="usa-fieldset" data-required-message="Please select a gender">
  ...
  <div class="usa-radio">
    <input type="radio" class="usa-radio__input usa-radio__input--tile" id="male" name="gender" value="male" aria-describedby="error-message-gender" aria-invalid="true"/>
    <label class="usa-radio__label" for="male">Male</label>
  </div>
  <div class="usa-radio">
    <input type="radio" class="usa-radio__input usa-radio__input--tile" id="female" name="gender" value="female" aria-describedby="error-message-gender" aria-invalid="true"/>
  ...
  public void radio_with_error_and_help_text() {
    assertHtml(
        ...
        <cf:radio
            ...
            th:is-valid="${model.isValid()}"
            th:validation-message="${model.validationMessage()}">
          <item id="free" value="free" text="Free"/>
          <item id="premium" value="premium" text="Premium"/>
        </cf:radio>
        """,
        // expected
        """
...
<fieldset class="usa-fieldset" data-required-message="Please select a subscription plan">
  ...
  <div class="usa-radio">
    <input type="radio" class="usa-radio__input usa-radio__input--tile" id="free" name="subscription" value="free" aria-describedby="error-message-subscription" aria-invalid="true"/>
    <label class="usa-radio__label" for="free">Free</label>
  </div>
  <div class="usa-radio">
    <input type="radio" class="usa-radio__input usa-radio__input--tile" id="premium" name="subscription" value="premium" aria-describedby="error-message-subscription" aria-invalid="true"/>
  ...
  public void required_radio() {
    assertHtml(
        ...
        <cf:radio
          ...
          <item id="yes" value="yes" text="Yes"/>
          <item id="no" value="no" text="No"/>
        </cf:radio>
        """,
        // expected
        """
  ...
  public void radio_with_selected_item() {
    assertHtml(
        ...
        <cf:radio
            ...
            th:name="${model.name()}"
            th:label="${model.label()}">
          <item id="small" value="small" text="Small"/>
          <item id="medium" value="medium" text="Medium" selected="true"/>
          <item id="large" value="large" text="Large"/>
        </cf:radio>
        """,
        // expected
        """
  ...
  public void radio_with_disabled_item() {
    assertHtml(
        ...
        <cf:radio
            ...
            th:name="${model.name()}"
            th:label="${model.label()}">
          <item id="credit" value="credit" text="Credit Card"/>
          <item id="debit" value="debit" text="Debit Card" disabled="true"/>
          <item id="paypal" value="paypal" text="PayPal"/>
        </cf:radio>
        """,
        // expected
        """
...
<cf:radio
    ...
    th:name="${model.name()}"
    th:label="${model.label()}">
  <item id="bronze" value="bronze" text="Bronze" description="$5/month - Basic features"/>
  <item id="silver" value="silver" text="Silver" description="$10/month - Enhanced features"/>
  <item id="gold" value="gold" text="Gold" description="$20/month - All features"/>
</cf:radio>
""",
        // expected
        """
  ...
  public void radio_not_tiled() {
    assertHtml(
        ...
        <cf:radio
          ...
          <item id="option1" value="option1" text="Option 1"/>
          <item id="option2" value="option2" text="Option 2"/>
        </cf:radio>
        """,
        // expected
        """
  ...
  public void radio_with_thymeleaf_item_attributes() {
    assertHtml(
        ...
        <cf:radio
            ...
            th:name="${model.name()}"
            th:label="${model.label()}">
          <item th:id="${model.id()}" th:value="${model.id()}" th:text="${model.label()}"/>
        </cf:radio>
        """,
        // expected
        """
...
<cf:radio
    ...
    th:name="${model.name()}"
    th:label="${model.label()}">
  <item id="track1" value="track1" text="Option 1" data-testid="tracking-radio" data-analytics="track-me"/>
</cf:radio>
""",
        // expected
        """
  ...
  public void radio_with_aria_attributes() {
    assertHtml(
        ...
        <cf:radio
            ...
            th:name="${model.name()}"
            th:label="${model.label()}">
          <item id="option1" value="option1" text="Option 1" aria-label="First option"/>
        </cf:radio>
        """,
        // expected
        """
  ...
  public void radio_with_all_attributes() {
    assertHtml(
        ...
        <cf:radio
            ...
            th:required="${model.required()}"
            th:tiled="${model.tiled()}">
          <item id="opt1" value="opt1" text="Option 1" description="First option" selected="true"/>
          <item id="opt2" value="opt2" text="Option 2" description="Second option"/>
          <item id="opt3" value="opt3" text="Option 3" description="Third option" disabled="true"/>
        </cf:radio>
        """,
        // expected
        """
...
""");
  ...
  public void radio_without_id_throws() {
    assertException(
        ...
        <cf:radio
            name="test"
            label="Test Label">
          <item id="item1" value="item1" text="Item 1"/>
        </cf:radio>
        """,
        // expected
  ...
  @Test
  public void radio_item_without_text_throws() {
    assertException(
        // template
        """
        <cf:radio
