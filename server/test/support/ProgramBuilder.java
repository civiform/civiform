...
public class ProgramBuilder {
  ...
  public ProgramModel build() {
    ...
    ApplicationStatusesRepository appStatusRepo = injector.instanceOf(ApplicationStatusesRepository.class);
    appStatusRepo.createOrUpdateStatusDefinitions(programDefinition.adminName(),programDefinition.statusDefinitions());
