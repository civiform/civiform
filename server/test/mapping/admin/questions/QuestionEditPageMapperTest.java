...
public final class QuestionEditPageMapperTest {
  ...
  private QuestionEditPageViewModel mapTextForm(TextQuestionForm form) {
    return mapper.map(
        1L, form, Optional.empty(), null, false, readOnlyQuestionService, Optional.empty());
  }
  ...
  public void map_setsQuestionId() {
    ...
    QuestionEditPageViewModel result =
        mapper.map(
            42L, form, Optional.empty(), null, false, readOnlyQuestionService, Optional.empty());
  ...
  public void map_displayModeShownWhenApiBridgeEnabled() {
    ...
    QuestionEditPageViewModel result =
        mapper.map(
            1L, form, Optional.empty(), null, true, readOnlyQuestionService, Optional.empty());
