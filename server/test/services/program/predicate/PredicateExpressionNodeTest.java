...
public class PredicateExpressionNodeTest {
  ...
  public void toDisplayString_leafNodeOnly() {
    ...
    assertThat(node.toFormattedDisplayString(ImmutableList.of(question)).toString())
        .isEqualTo(
            String.format(
  ...
  public void toDisplayString_addressServiceAreaNodeOnly_questionIsPresent() {
    ...
    assertThat(
            PredicateExpressionNode.create(leaf)
                .toFormattedDisplayString(ImmutableList.of(question))
                .toString())
        .isEqualTo(
            String.format(
  ...
  public void toDisplayString_addressServiceAreaNodeOnly_questionIsNotPresent() {
    ...
    assertThat(
            PredicateExpressionNode.create(leaf)
                .toFormattedDisplayString(ImmutableList.of())
                .toString())
        .isEqualTo(
            String.format(
  ...
  public void toDisplayString_orNode() {
    ...
    assertThat(node.toFormattedDisplayString(ImmutableList.of(multiOption, date)).toString())
        .isEqualTo(
            String.format(
