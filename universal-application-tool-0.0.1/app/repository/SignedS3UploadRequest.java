...
public abstract class SignedS3UploadRequest {
  ...
  public abstract static class Builder {
    ...
    /** Get currently set successActionRedirect. This is used to build the policy. */
    abstract Optional<String> successActionRedirect();
    ...
    Builder buildPolicy() {
      UploadPolicy.Builder builder =
          UploadPolicy.builder()
              ...
              .setDate(date());
      if (successActionRedirect().isPresent()) {
        builder.setSuccessActionRedirect(successActionRedirect().get());
      }
