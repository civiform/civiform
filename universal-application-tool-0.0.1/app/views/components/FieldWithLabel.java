...
public class FieldWithLabel {
  ...
  public ContainerTag getContainer() {
    ...
    return div(labelTag, div(fieldTag, buildFieldErrorsTag()).withClasses(Styles.FLEX, Styles.FLEX_COL).withId("test-input-and-error"))
        .withClasses(StyleUtils.joinStyles(referenceClassesBuilder.build().toArray(new String[0])),
