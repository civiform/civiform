...
public class Icons {
  ...
  // Stop (circle with a square inside)
  public static final String RADIO_BUTTON_SVG_PATH = "M21 12a9 9 0 11-18 0 9 9 0 0118 0z";
  ...
  public static ContainerTag questionTypeSvg(QuestionType type, int width, int height) {
    ...
    switch (type) {
      ...
      case RADIO_BUTTON:
        return svg(Icons.RADIO_BUTTON_SVG_PATH, width, height)
            .attr("fill", "none")
            .attr("stroke-linecap", "round")
            .attr("stroke-linejoin", "round")
            .attr("stroke-width", "2");
