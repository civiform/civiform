...
public class AdminQuestionController extends CiviFormController {
  ...
  /** Return a HTML page containing a form to create a new question. */
  @Secure(authorizers = Authorizers.Labels.CIVIFORM_ADMIN)
  ...
  /** POST endpoint for creating a new quesiton. */
  @Secure(authorizers = Authorizers.Labels.CIVIFORM_ADMIN)
  ...
  /** POST endpoint for un-archiving a quesiton. */
  @Secure(authorizers = Authorizers.Labels.CIVIFORM_ADMIN)
  ...
  /** POST endpoint for archiving a quesiton. */
  @Secure(authorizers = Authorizers.Labels.CIVIFORM_ADMIN)
  ...
  /** POST endpoint for discarding a draft for a quesiton. */
  @Secure(authorizers = Authorizers.Labels.CIVIFORM_ADMIN)
  ...
  /** Return a HTML page containing all configurations of a question and forms to edit them. */
  @Secure(authorizers = Authorizers.Labels.CIVIFORM_ADMIN)
  ...
  /** POST endpoint for updating a quesiton. */
  @Secure(authorizers = Authorizers.Labels.CIVIFORM_ADMIN)
