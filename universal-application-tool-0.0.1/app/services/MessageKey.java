...
public enum MessageKey {
  ...
  BUTTON_ADD_ENUMERATOR_ENTITY("button.addEnumeratorEntity"),
  BUTTON_APPLY("button.apply"),
  BUTTON_ARIA_LABEL_DELETE_ENTITY("button.ariaLabel.deleteEntity"),
  ...
  NAME_VALIDATION_FIRST("validation.firstNameRequired"),
  NAME_VALIDATION_LAST("validation.lastNameRequired"),
  ...
  TITLE_PROGRAMS_PAGE("title.programs"),
