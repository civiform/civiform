...
update programs set localized_name = '{"en_US" : "' || name || '"}' where localized_name is null;
update programs set localized_description = '{"en_US" : "' || description || '"}' where localized_description is null;
